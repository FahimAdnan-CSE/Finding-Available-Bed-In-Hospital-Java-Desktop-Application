...
public class PageNo_1_2_AdminForm extends javax.swing.JFrame {

    public PageNo_1_2_AdminForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        searchWithId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchWithIdActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, formPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(formPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, formPanelLayout.createSequentialGroup()
                                        ...
                                        .addGap(83, 83, 83))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, formPanelLayout.createSequentialGroup()
                                        .addComponent(pendingStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(34, 34, 34)))))))
    ...
    private void logoutBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutBtnActionPerformed
        PageNo_1_0_MainFrame mainFrame = new PageNo_1_0_MainFrame();
        mainFrame.setVisible(true);
        PageNo_1_2_AdminForm frame = new PageNo_1_2_AdminForm();
    ...
    private void deleteRecordBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRecordBtnActionPerformed
        ...
        String searchTextStr = searchWithId.getText();
        try{
            Connection mySqlConn = CodeSQLConnection.getConnection();
    ...
    private void pendingHospitalBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pendingHospitalBtnActionPerformed
        PageNo_1_3_PendingHospitalList pendingHospital = new PageNo_1_3_PendingHospitalList();
        pendingHospital.setVisible(true);
    }//GEN-LAST:event_pendingHospitalBtnActionPerformed

    private void searchWithIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchWithIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_searchWithIdActionPerformed
    ...
    private void searchWithIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchWithIdKeyReleased
      ...
      String searchTextStr = searchWithId.getText();
        if(!searchTextStr.isEmpty()){
            CodeOperations operations = new CodeOperations();
            operations.searchIDHospitalData(searchTextStr,pendingStatus,hospitalRecordList,this);
        }
        else if(searchTextStr.isEmpty()){
            CodeOperations operations = new CodeOperations();
            operations.searchIDHospitalData(searchTextStr,pendingStatus,hospitalRecordList,this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageNo_1_2_AdminForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new PageNo_1_2_AdminForm().setVisible(true);
            }
        });
    }
