...
public class PageNo_2_1_HospitalRegistration extends javax.swing.JFrame {


    public PageNo_2_1_HospitalRegistration() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageNo_2_1_HospitalRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PageNo_2_1_HospitalRegistration().setVisible(true);
            }
        });
    }
