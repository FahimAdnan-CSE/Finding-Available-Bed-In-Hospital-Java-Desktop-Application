...
public class PageNo_1_3_PendingHospitalList extends javax.swing.JFrame {

    public PageNo_1_3_PendingHospitalList() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pendingIdTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pendingIdTxtActionPerformed(evt);
            }
        });
    ...
    private void pendingIdTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pendingIdTxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pendingIdTxtActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageNo_1_3_PendingHospitalList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new PageNo_1_3_PendingHospitalList().setVisible(true);
            }
        });
    }
