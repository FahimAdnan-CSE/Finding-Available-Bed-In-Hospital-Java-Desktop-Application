...
public class CodeCustomRenderer extends DefaultListCellRenderer implements ListCellRenderer<Object>{    
    
    @Override
    public Component getListCellRendererComponent(JList<?>list,Object value,int index,boolean isSelected,boolean hsaFocus){
        
        CodeHospitalInfo hospitalInfo = (CodeHospitalInfo) value;
        ...
        */
        String details = "<html><div style=\"background-color: #F5FFFA;  padding: 18px; margin:10px; width:100%\">"+
                         ...
                         "<br/><div style=\"padding-left:10px; padding-right:10px; background-color: 00a2e8; color: black;font-size:20px;border-radius:12px;\">"  + "  Total Normal Bed: "+totalNormalBed+ "<span style='display:block; background-color:00a2e8;color:00a2e8;'>Hidden</span><span style='display:block; background-color:#F5FFFA;color:#F5FFFA;'>Te</span>" + " Available Normal Bed:"+seatNumber+"</div>"+
                         "<br/><div style=\"padding-left:10px; padding-right:10px; background-color: 00a2e8; color: black;font-size:20px;border-radius:12px;\">"  + "  Total  Bed      : "+totalBed+  "<span style='display:block; background-color:00a2e8;color:00a2e8;'>HiddenText11</span><span style='display:block; background-color:#F5FFFA;color:#F5FFFA;'>Te</span>" + "Total Uses Bed: "+totalUses+"</div>"+
                         "<br/><div style=\"padding: 8px;text-align:center; background-color: 00a2e8; color: black;font-size:20px;border-radius:12px;width:530px\">"+"Available Total Bed: " + totalAvilablleBed + " </div></html>";
