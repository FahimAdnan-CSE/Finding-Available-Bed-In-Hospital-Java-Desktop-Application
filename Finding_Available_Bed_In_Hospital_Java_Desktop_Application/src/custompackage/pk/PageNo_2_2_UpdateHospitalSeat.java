...
public final class PageNo_2_2_UpdateHospitalSeat extends javax.swing.JFrame{

    public PageNo_2_2_UpdateHospitalSeat() {      
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(normalbed, javax.swing.GroupLayout.PREFERRED_SIZE, 837, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbuttonActionPerformed
        try {            
            PageNo_1_1_AdminHospitalLogin login = new PageNo_1_1_AdminHospitalLogin();
            ...
            Logger.getLogger(PageNo_2_2_UpdateHospitalSeat.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageNo_2_2_UpdateHospitalSeat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        new PageNo_2_2_UpdateHospitalSeat().setVisible(true);
    }
